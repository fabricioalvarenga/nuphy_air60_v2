...
- Select 'DESIGN' from the top menu
...
- Click 'LOAD' and choose the file nuphy-air60-v2-via_definition.json
- Select 'CONFIGURE' from the top menu
- Select 'KEYMAP' from the side menu
- Select 'BASIC' from the side submenu
- Press the DEL key on the keyboard map
- Find the `~` button on the map at the bottom of the screen and click it
- Press the ESC key on the map
- Select 'SPECIAL' from the side submenu
- Find the 'Any' button on the map at the bottom of the screen, click it, type KC_GESC and click 'Confirm'
